...
if user_has_typed:
    ...
    caption_text = f"綜合評估 <strong>{target_symbol}</strong> 之「基本面護城河、估值性價比、機構籌碼、技術量價動能、另類數據信號」五大核心因子。"
...
<div style="background:#F8F5F1; border:1px solid #D8CFC7; border-left:6px solid #6B584C; border-radius:10px; padding:14px 18px; margin-top:36px; margin-bottom:18px;">
    <div style="display:flex; align-items:center; gap:10px;">
        ...
        <span style="font-size:1.24rem; font-weight:800; color:#4A3E36;">五、澄璞全方位量化分析終端 — 11 大模組功能導航</span>
    </div>
...
with col_p2:
    ...
    if st.button("🚀 開通進階量化版 (NT$ 200/月 或 年繳 2,000)", key="btn_pay_200", type="secondary", use_container_width=True):
        modal_checkout(
            ...
            monthly_price=200,
            annual_price=2000,
            monthly_url="https://payment.ecpay.com.tw",  # 可換成您的 200 元月繳刷卡連結
            annual_url="https://payment.ecpay.com.tw"    # 可換成您的 2000 元年繳刷卡連結
        )
...
with col_p3:
    ...
    <div class="pricing-box-wrapper popular">
        ...
        <div>
            ...
            <div style="color: #2D2622; font-size: 0.90rem; line-height: 2.1;">
                <div><span style="color:#0D9488; font-weight:800;">✔</span> <strong>100% 完整解鎖全系統 11 大分析模組</strong></div>
    ...
    if st.button("🌟 開通專業全能旗艦版 (NT$ 300/月 或 年繳 3,000)", key="btn_pay_300", type="primary", use_container_width=True):
        modal_checkout(
            ...
            monthly_price=300,
            annual_price=3000,
            monthly_url="https://payment.ecpay.com.tw",  # 可換成您的 300 元月繳刷卡連結
            annual_url="https://payment.ecpay.com.tw"    # 可換成您的 3000 元年繳刷卡連結
        )
